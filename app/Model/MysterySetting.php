 ...
 * @property int $type 类型 1:基础任务  2:互动任务 3:观看专属视频
...
class MysterySetting extends Model
{
     ...
     * @var array
     */
    protected $casts = ['id' => 'integer', 'award_num' => 'integer', 'award_type' => 'integer', 'total_num' => 'integer', 'type' => 'integer', 'sort' => 'integer', 'status' => 'integer', 'activity_id' => 'integer', 'operator_id' => 'integer', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'deleted_at' => 'integer'];
}
 ...
 */
class WithdrawOrder20211013 extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'withdraw_order-20211013';
    /**
     ...
     * @var array
     */
    protected $casts = ['id' => 'integer', 'uid' => 'integer', 'sn' => 'integer', 'amount' => 'integer', 'point' => 'integer', 'setting_id' => 'integer', 'condition_index' => 'integer', 'status' => 'integer', 'day' => 'integer', 'created_at' => 'datetime', 'updated_at' => 'datetime'];
}
 ...
 */
class WithdrawOrder20211014 extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'withdraw_order-20211014';
    /**
     ...
     * @var array
     */
    protected $casts = ['id' => 'integer', 'uid' => 'integer', 'sn' => 'integer', 'amount' => 'integer', 'point' => 'integer', 'setting_id' => 'integer', 'status' => 'integer', 'day' => 'integer', 'created_at' => 'datetime', 'updated_at' => 'datetime', 'condition_index' => 'integer'];
}